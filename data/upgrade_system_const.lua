...
US_CONFIG = {
  {
    [ITEM_UPGRADE_CRYSTAL] = 26385, -- Upgrade Crystal item id
    [ITEM_ENCHANT_CRYSTAL] = 26387, -- Enchantment Crystal item id
    [ITEM_ALTER_CRYSTAL] = 26388, -- Alteration Crystal item id
    [ITEM_CLEAN_CRYSTAL] = 26389, -- Cleansing Crystal item id
    [ITEM_FORTUNE_CRYSTAL] = 26390, -- Fortune Crystal item id
    [ITEM_FAITH_CRYSTAL] = 26391, -- Faith Crystal item id
    [ITEM_MIND_CRYSTAL] = 26392, -- Mind Crystal item id
    [ITEM_LIMITLESS_CRYSTAL] = 26393, -- Limitless Crystal item id
    [ITEM_MIRRORED_CRYSTAL] = 26394, -- Mirrored Crystal item id
    [ITEM_VOID_CRYSTAL] = 26395 -- Void Crystal item id
  },
  ITEM_SCROLL_IDENTIFY = 26386, -- Scrol of Identification item id
  ITEM_UPGRADE_CATALYST = 26383, -- Upgrade Catalyst item id
  CRYSTAL_EXTRACTOR = 26384, -- Crystal Extractor item id
  ...
  --
  CRYSTAL_FOSSIL_DROP_CHANCE = 1, -- 1:X chance that Crystal Fossil will drop from monster, X means that approximately every X monster will drop Crystal Fossil
